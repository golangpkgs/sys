...
import (
	...
	"github.com/golangpkgs/sys/windows/svc"
	"github.com/golangpkgs/sys/windows/svc/mgr"
)
...
func TestExample(t *testing.T) {
	...
	o, err := exec.Command("go", "build", "-o", exepath, "github.com/golangpkgs/sys/windows/svc/example").CombinedOutput()
	if err != nil {
